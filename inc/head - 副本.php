      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width=960 background=images/MenuBG1_2007329_55755.gif align=center height=30>
        ...
        <TR>
          ...
          <?php 
		  $SqlStr="SELECT root,FunctionName,FunctionDir,ManageFunId,Deep,IsManage,IsUse from webfunction where Deep = 2 and IsManage=1 and IsUse = 1 AND ManageFunId>0 order by OrderID";
		...
		while($row = mysql_fetch_array($rs)) 
		{
			...
			echo '<TD style="PADDING-TOP: 0px" align=middle>';
			echo '<A href="'.$FunctionDir.'"><FONT style="FONT-FAMILY: 宋体; COLOR: #ffffff; FONT-SIZE: 9pt" onmousemove="this.style.color=\'#f38401\';this.style.textDecoration=\'none\'" onmouseout="this.style.color=\'#ffffff\'">'.$FunctionName.'</FONT></A></TD>';
}
