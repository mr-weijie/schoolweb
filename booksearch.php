  ...
  <tbody>
    <tr>
      <td><table width="100%" border="0" cellspacing="1" cellpadding="2">
        <form name="frmsearch" method="Post" action="./booklist.php" target="framelist">
        <tbody>
          <tr>
        ...
        <iframe name="framelist" src="./booklist.php" border="0" width="100%" height="700" frameborder="1"></iframe></td>
    </tr>
  </tbody>
</table>
</body></html>