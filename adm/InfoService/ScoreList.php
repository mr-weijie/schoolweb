...
if($Act!='') 
{
	DeleteRecord("infosearch_scores",$_POST['DelRowID']);//删除目标记录
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ManageList">
  ...
  <tbody><tr>
	...
	$SqlStr="Select ID,RowID,Flag,ClassName,TermName from InfoSearch_scores ".$ConStr." Order by ID limit ".($CurPage-1)*$Nums.",".$Nums;;
	$rs = mysql_query($SqlStr);
	$XH=0;
