    ...
    <td height="100%">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" height="100%">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          	<tbody>
            	<tr><td height="31" background="../images/ManageFunListTop.gif" align="center"><font color="darkred"><?php echo $_SESSION['Admin']?> 您好！</font></td></tr>
                    <?php 
		$flag=$_GET['flag'];
		$SqlStr="SELECT RowID,FunctionName,FunctionDir,FunctionFileName,FunctionTable from managefunction Where Root='".$flag."' order by SortId ";
  		...
  		while($row = mysql_fetch_array($rs)) 
		{
			...
			$FunctionTable=$row['FunctionTable'];
        	echo '<tr><td height="24" background="../images/ManageFunListBar.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%"><tbody><tr><td width="30">&nbsp;</td><td><a href="'.$FunctionFileName.'?rowid='.$RowID.'&tbn='.$FunctionTable.'" target="framelist">'.$FunctionName.'</a></td></tr></tbody></table></td></tr>';
...
?>
          ...
          <td valign="top"><iframe name="framelist" src="right.html" border="0" width="100%" height="100%" frameborder="0"></iframe></td>
          </tr>
        </tbody></table>
      </td>
  </tr>
