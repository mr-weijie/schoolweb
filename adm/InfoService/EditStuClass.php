...
if($Act==1)
{
	...
	if(strlen($rowid)==0)
	{
		...
		$SqlStr="Insert Into InfoSearch_Stukebiao(RowID,Flag,ClassName,TermName,Title,KeBiaoContent) Values('".$rowid."','".$Flag."','".$ClassName."','".$TermName."','".$Title."','".$KeBiaoContent."')";
	}else
	{
		$SqlStr="Update InfoSearch_Stukebiao Set ClassName='".$ClassName."',TermName='".$TermName."',Title='".$Title."',KeBiaoContent='".$KeBiaoContent."' Where RowID='".$rowid."'";
	}
...
if(strlen($rowid)==32)
{
	$SqlStr="Select ID,RowID,Flag,ClassName,TermName,Title,KeBiaoContent from InfoSearch_Stukebiao Where RowID='".$rowid."'";
	$rs = mysql_query($SqlStr);
